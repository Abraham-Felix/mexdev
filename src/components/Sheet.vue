...
const creds = require('@/client_secret.json');
 ...
 { text: "Image", value: "Logo_URL", sortable: false },
 { text: 'Funding Date', value: 'Funding_Date' },
 { text: 'Amount Raised', value: 'Amount_Raised_Millions' },
 { text: 'Total Raised in millions', value: 'Total_Raised' },
 { text: 'Round', value: 'Round' },
 { text: 'Founder', value: 'Founder' },
 { text: 'Title', value: 'Title' },
 { text: 'EST Date', value: 'Est_Date' },
 { text: 'Location', value: 'Location' },
 { text: 'Lead Investor', value: 'Lead_Investor' },
 ],
				rows: [],
				loading: true,
			}
		...
		methods:{
			async accessSpreadSheet() {
				const doc = new GoogleSpreadsheet(process.env.VUE_APP_GS_MXDV_KEY);
