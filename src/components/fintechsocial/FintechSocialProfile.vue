...
<div id="app">
    <v-container class="v-container">
        <v-card v-if="authUser" class="center block">
                ...
                <v-row>
                    ...
                    <v-col class="col-12 col-md-6">
                        <v-container>
                            ...
                            <br>
                            <p class="center">Hello {{authUser.displayName || 'my friend'}}!
                                <br> We know you love {{authUser.favoriteFood || 'Fintech'}} </p>
                            <br>
            ...
            <h4 class="center mt-5">User details</h4>
            <br>
            <br>
            <v-card>
                <h4 class="left"><v-icon> mdi-account </v-icon> About you </h4>
                <br>
            ...
            <v-card>
                <h4 class="left"><v-icon> mdi-email mdi-lock </v-icon> Email & Password </h4>
                <br>
                <v-divider></v-divider>
                <v-row>
                    <v-col class="col-12 col-md-6">
            ...
            <v-card>
                <h4 class="left mt-5"> Professional details </h4>
                <br>
                <br>
                ...
                <v-row center no-gutters>
                    <v-col class="col-6 col-md-4">
                        <form @submit.prevent="updateCompanyDetails">
                            <h4><center><v-icon> mdi-domain </v-icon> Comapny </center> </h4>
                            <v-divider class="mb-5"></v-divider>
                            <v-text-field required type="text" v-model="companyName" label="Company name" placeholder="enter your company name" background-color="tertiary" class="form-control">
                            </v-text-field>
                    ...
                    <v-col class="col-12 col-md-4">
                        <form @submit.prevent="updateCompanyPhoto">
                            <h4 class="center"><v-icon> mdi-camera </v-icon> Company image </h4>
                            <v-divider></v-divider>
                            <br>
