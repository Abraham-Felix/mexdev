...
<v-card>
  ...
  />
  <v-text>
  <p> send us a request, one our developers will get back to you as soon as posible, we will do our best to find a solution, sincerly, <a href="mailto:mexdevservice@gmail.com"><b>mexdev support</b>.</a></p>
  </v-text>
    <div>
